...
static bool terminal_entrada_vazia(terminal_t *self) { return self->entrada[0] == '\0'; }
...
static bool terminal_pode_imprimir(terminal_t *self) { return self->estado_saida == normal; }
...
char *terminal_txt_entrada(terminal_t *self) { return self->entrada; }

char *terminal_txt_saida(terminal_t *self) { return self->saida; }
